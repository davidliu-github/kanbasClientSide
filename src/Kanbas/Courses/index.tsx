              ...
              <ul className="list-group wd-modules">
                <li className="list-group-item">
                  <div className="list-header">
                    <i className="fa fa-ellipsis-v"></i>
                    <i className="ml-3 mr-3 fa fa-caret-down " aria-hidden="true"></i>
                    Week 0
                  ...
                  <ul className="list-group">
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i> Learning Objectives
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                        <i className="fa fa-ellipsis-v ms-2"></i>
                      </span>
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i>
                      <label className="sub-list">Introduction to the course</label>
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                        <i className="fa fa-ellipsis-v ms-2"></i>
                      </span>
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i>
                      <label className="sub-list">What is Web Development</label>
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                        <i className="fa fa-ellipsis-v ms-2"></i>
                      </span>
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i> <label className="sub-list">
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i> <label className="sub-list">Creating a Web
                        Application</label>
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                        <i className="fa fa-ellipsis-v ms-2"></i>
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i> <label>
                        Reading
                      </label>
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                    ...
                    <li className="list-group-item">
                      <i className="fa fa-ellipsis-v"></i> <label className="sub-list">
                        Full Stack Developer - Chapter 1 - Introduction </label>
                      <span className="float-end">
                        <i className="fa fa-check-circle text-success"></i>
                        <i className="fa fa-ellipsis-v ms-2"></i>
                      </span>
                    ...
                    <li className="list-group-item">
                      ...
                      <a href="#">
                        <label className="link-space">Introduction to Web Development</label>
                    ...
                    <li className="list-group-item">
                      ...
                      <i className="fa fa-link" aria-hidden="true"></i>
                      <a href="#">
                        <label className="link-space">Creating an HTTP server with Node.js</label>
                        <i className="fa fa-external-link" aria-hidden="true"></i>
                        <span className="float-end">
                          <i className="fa fa-check-circle text-success"></i>
                          <i className="fa fa-ellipsis-v ms-2"></i>
                    ...
                    <li className="list-group-item">
                      ...
                      <i className="fa fa-link" aria-hidden="true"></i>
                      <a href="#">
                        <label className="link-space">Creating a React Application</label>
                        <i className="fa fa-external-link" aria-hidden="true"></i>
                        <span className="float-end">
                          <i className="fa fa-check-circle text-success"></i>
                          <i className="fa fa-ellipsis-v ms-2"></i>
